...
- Only the current sprint is detailed; finished sprints are **gone**, their knowledge already in the wiki.
- A sprint **closes** with a [retro](the-retro.md), and only once its durable learnings are captured
  ([gates](gates.md) capture-before-close). Then its log may be trimmed to nothing.
